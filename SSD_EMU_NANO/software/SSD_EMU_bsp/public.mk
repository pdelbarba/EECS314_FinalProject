...
JDI_FILE := C:/Users/Robert/Documents/MBC/OFFCHIP/SSD_EMU/SSD_EMU.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40410e8
SOPC_SYSID_FLAG += --sidp=0x40410e8
ELF_PATCH_FLAG  += --sidp 0x40410e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1353270030
SOPC_SYSID_FLAG += --timestamp=1353270030
ELF_PATCH_FLAG  += --timestamp 1353270030
